...
internal fun formatCurrency(value: Int, divisor: Int, currencyCode: String, isBalance: Boolean): String {
    return value.toString() + divisor.toString() + currencyCode + isBalance.toString()
}

@Serializable
@SerialName("currency")
sealed class TransitCurrencyBase : TransitBalance(), Parcelable {
    abstract fun formatCurrencyString(isBalance: Boolean): String
...
data class TransitCurrency (
     ...
     */
    override fun formatCurrencyString(isBalance: Boolean): String {
