...
data class TagDesc(val name: String ,
...
interface TagContentsInterface {
    fun interpretTagString(data: ImmutableByteArray): String
    fun interpretTag(name: String , data: ImmutableByteArray): ListItemInterface? =
            if (data.isEmpty())
                null
            else
...
enum class TagContents : TagContentsInterface {
    ...
    DUMP_LONG {
        override fun interpretTagString(data: ImmutableByteArray): String = data.toHexString()
        override fun interpretTag(name: String , data: ImmutableByteArray): ListItemInterface? =
    ...
    HIDE {
        ...
        override fun interpretTag(name: String , data: ImmutableByteArray): ListItemInterface? = null
    },
    CURRENCY {
        override fun interpretTagString(data: ImmutableByteArray): String {
    ...
    COUNTRY_BCD {
        override fun interpretTagString(data: ImmutableByteArray): String = countryCodeToName(
            NumberUtils.convertBCDtoInteger(data.byteArrayToInt()))
    },
    COUNTRY_ASCIINUM {
    ...
    CONTENTS_DATE {
        ...
        override fun interpretTagString(data: ImmutableByteArray): String = when(data.size) {
            3 -> Daystamp(
                    ...
                    data.convertBCDtoInteger(2, 1)).format()
