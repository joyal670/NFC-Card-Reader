...
object CalypsoData {
    ...
    private val manufacturerNames = mapOf(
            ...
            0x00 to "ASK",
            0x01 to "Intec",
            0x02 to "Calypso Networks Association",
            0x03 to "Ascom",
            0x04 to "Thales",
            0x05 to "Sagem",
            0x06 to "Axalto",
            ...
            0x0D to "Calmell",
            0x0E to "Mecstar",
            0x0F to "ACG Identification Technologies",
            0x10 to "STMicroelectronics",
            0x11 to "Calypso Networks Association",
            0x12 to "Giesecke &amp; Devrient",
            0x13 to "OTI",
            0x14 to "Gemalto",
            0x15 to "Watchdata",
            0x16 to "Alios",
            0x17 to "S-P-S",
            0x18 to "IRSA",
            0x20 to "Calypso Networks Association",
            0x21 to "Innovatron",
            0x2E to "Calypso Networks Association"
    )
